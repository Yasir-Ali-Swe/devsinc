...
const Hero = () => {
    return (
        <div className='h-screen relative overflow-hidden'>
            ...
            <div className='absolute top-[25%] left-6 lg:top-1/3 lg:left-20 z-40 text-white'>
                ...
                <h1 className='text-xl lg:text-2xl lg:mb-2'>We help companies redefine the future
                    <span className='lg:hidden'> through technology</span>
                </h1>
                <h1 className='hidden lg:block lg:text-2xl lg:mb-6'>through technology</h1>
                <button className='px-3 py-2 mt-2 lg:mt-4 lg:px-6 lg:py-3 cursor-pointer text-white rounded-3xl bg-primary'>
                    Get in Touch
                </button>
            </div>
        </div>
